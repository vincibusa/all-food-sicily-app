...
export default function HotelScreen() {
  ...
  if (!hotel) {
    return (
      <SafeAreaView style={[styles.container, styles.centerContent, { backgroundColor: colors.background }]}>
        <Text style={[styles.errorText, { color: colors.text }]}>Hotel non trovato</Text>
      </SafeAreaView>
    );
  }
          ...
          >
            ...
            {hotel.phone && (
              <View style={styles.infoItem}>
                ...
                <Text style={[styles.infoText, { color: colors.text }]}>{hotel.phone}</Text>
              </View>
            )}
            {hotel.email && (
              <View style={styles.infoItem}>
                <MaterialIcons name="email" size={20} color={colors.primary} />
                <Text style={[styles.infoText, { color: colors.text }]}>{hotel.email}</Text>
              </View>
            )}
            {hotel.website && (
              <View style={styles.infoItem}>
                <MaterialIcons name="language" size={20} color={colors.primary} />
                <Text style={[styles.infoText, { color: colors.text }]}>{hotel.website}</Text>
              </View>
            )}
            ...
            {hotel.hotel_type && hotel.hotel_type.length > 0 && (
              <>
                <Text style={[styles.sectionTitle, { color: colors.text, marginTop: 24 }]}>Tipo di Struttura</Text>
            ...
            {hotel.review_count > 0 && (
              <>
                <Text style={[styles.sectionTitle, { color: colors.text, marginTop: 24 }]}>Recensioni</Text>
                <View style={styles.reviewsContainer}>
                  <Text style={[styles.reviewsText, { color: colors.text }]}>
            ...
            <Animated.View entering={FadeInDown.delay(200)}>
              ...
              {hotel.star_rating && (
                <View style={styles.starRatingContainer}>
                  ...
                  <Text style={[styles.starRatingText, { color: colors.text + '80' }]}>
